---
sidebar:
  title: 28.TSConfig 全解（下）：检查相关、工程相关配置
  step: 27
isTimeLine: true
title: 28.TSConfig 全解（下）：检查相关、工程相关配置
date: 2020-04-14
...
在某些可能产生 `string | undefined` 类型的方法中，如果关闭了 strictNullChecks 检查，就意味着很可能下面会遇到一个 **_cannot read property 'xxx' of undefined_** 的错误：
